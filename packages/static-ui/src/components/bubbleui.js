...
export default function BubbleElement(props) {
  ...
  return (
    ...
    >
      <div className={css(styles.container)} onScroll={handleScroll}>
        {/* <p>{`scrollTop: ${scrollTop}`}</p>
        <p>{`scrollLeft: ${scrollLeft}`}</p> */}
        <div className={css(styles.scrollable)} ref={scrollable}>
          <div
            className={css(styles.horizontalSpacer)}
            style={{
                ...
                >
                  {row.map((comp, j) => {
                    ...
                    return (
                      <div
                        key={j}
                        className={css(styles.bubbleContainer)}
                        style={{
                          width: options.size,
                          height: options.size,

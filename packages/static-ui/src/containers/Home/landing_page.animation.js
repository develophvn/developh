		...
		var r = n(2),
			...
			T = function (t, e) {
				...
				if (E && !_)
					...
					for (var j = (O - g) / I, F = E.config.easing, G = h(F, j, f), X = 0, k = a.length; X < k; X++) {
						var V = a[X],
							U = y(s, V, E.config),
	...
	Webflow.require('ix2').init({
		...
		"actionLists": {
				...
				"actionItemGroups": [{
					"actionItems": [{
						...
						"config": {
							...
							"target": {
								"useEventTarget": "CHILDREN",
								"selector": ".event-img.red-backdrop",
								"selectorGuids": ["1487e839-e34d-cc4a-e381-c0662da1b990", "f83202af-24bc-b539-ae53-e8f30d452d26"]
							},
							"xValue": 0,
							"yValue": 0,
							"xUnit": "px",
			...
			"a-17": {
					...
					"actionItems": [{
						...
						"config": {
							...
							"target": {
								...
								"selector": ".event-wae",
								"selectorGuids": ["04d35a33-5620-1997-5ab0-e1cc12dff3a4"]
							},
							"value": 1,
							"unit": ""
						}
				...
				"useFirstGroupAsInitialState": true,
				"createdOn": 1624869376576
			},
			"a-18": {
				"id": "a-18",
				"title": "hover-event-opacity 2",
				"actionItemGroups": [{
					"actionItems": [{
						"id": "a-18-n",
						"actionTypeId": "STYLE_OPACITY",
